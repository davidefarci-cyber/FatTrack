# BATCH 11 / 11 — illustrazioni esercizi FatTrack

## Istruzioni per la chat GPT

Genera UNA immagine per ognuno dei 2 prompt elencati sotto. Ogni prompt è auto-contenuto: stile, palette e formato sono ripetuti in ogni blocco. Segui ESATTAMENTE il prompt di ciascuno.

Al termine di tutte le 2 immagini, raggruppale in un singolo file ZIP chiamato `fattrack-exercises-batch-11.zip` con i PNG nominati esattamente come indicato nel campo "**Nome file**" di ogni blocco. I nomi devono essere:
...
NOTE SPECIFICHE: Inquadratura un po' più stretta del solito per dare risalto a mani e polsi.
```

---
## 2. Caviglie - Ankle circles

**Nome file**: `ankle-circles.png`

```text
Crea un'illustrazione di un esercizio fitness coerente con il design system di un'app mobile.

ESERCIZIO: Caviglie - Ankle circles
STRATEGIA: Singolo frame con il personaggio nella posizione descritta.
...
NOTE SPECIFICHE: Vista a 3/4 per evidenziare il piede sollevato. La sedia è un rettangolo neutro #1E2532.
```
...
Quando hai completato tutte le 2 immagini di questo batch, raggruppale in `fattrack-exercises-batch-11.zip` con i nomi file esatti indicati in ciascun blocco. Conferma a fine generazione che ogni filename corrisponde correttamente prima di creare lo ZIP.
