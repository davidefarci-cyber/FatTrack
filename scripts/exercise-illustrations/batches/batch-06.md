# BATCH 06 / 11 — illustrazioni esercizi FatTrack
...
Al termine di tutte le 7 immagini, raggruppale in un singolo file ZIP chiamato `fattrack-exercises-batch-06.zip` con i PNG nominati esattamente come indicato nel campo "**Nome file**" di ogni blocco. I nomi devono essere:
...
NOTE SPECIFICHE: Vista a 3/4 dal lato per mostrare l'apertura laterale dell'anca. Niente frecce a indicare il movimento — solo la posizione.
```

---
## 2. Spalle - Shoulder rolls

**Nome file**: `shoulder-rolls.png`

```text
Crea un'illustrazione di un esercizio fitness coerente con il design system di un'app mobile.

ESERCIZIO: Spalle - Shoulder rolls
...
FRAME 1 (sinistra) — Posizione bassa: in piedi vista frontale, braccia rilassate lungo i fianchi, spalle in posizione neutra verso il basso.

FRAME 2 (destra) — Posizione alta: in piedi vista frontale, spalle sollevate verso le orecchie e leggermente arretrate, braccia ancora rilassate, in fase di rotazione.
...
**Nome file**: `pigeon-pose.png`

```text
Crea un'illustrazione di un esercizio fitness coerente con il design system di un'app mobile.

ESERCIZIO: Anche - Pigeon pose
STRATEGIA: Singolo frame con il personaggio nella posizione descritta.
...
NOTE SPECIFICHE: Vista a 3/4 per mostrare sia l'angolazione del ginocchio anteriore sia l'estensione della gamba posteriore.
```

---
## 4. Hamstring stretch

**Nome file**: `hamstring-stretch.png`

```text
Crea un'illustrazione di un esercizio fitness coerente con il design system di un'app mobile.

ESERCIZIO: Hamstring stretch
STRATEGIA: Singolo frame con il personaggio nella posizione descritta.
...
**Nome file**: `quad-stretch.png`

```text
Crea un'illustrazione di un esercizio fitness coerente con il design system di un'app mobile.

ESERCIZIO: Quad stretch
STRATEGIA: Singolo frame con il personaggio nella posizione descritta.
...
**Nome file**: `chest-opener.png`

```text
Crea un'illustrazione di un esercizio fitness coerente con il design system di un'app mobile.

ESERCIZIO: Chest opener
STRATEGIA: Singolo frame con il personaggio nella posizione descritta.
...
**Nome file**: `spinal-twist.png`

```text
Crea un'illustrazione di un esercizio fitness coerente con il design system di un'app mobile.

ESERCIZIO: Spinal twist
STRATEGIA: Singolo frame con il personaggio nella posizione descritta.
...
NOTE SPECIFICHE: Vista dall'alto (top-down) per mostrare chiaramente la torsione del busto e la croce delle braccia.
```
...
Quando hai completato tutte le 7 immagini di questo batch, raggruppale in `fattrack-exercises-batch-06.zip` con i nomi file esatti indicati in ciascun blocco. Conferma a fine generazione che ogni filename corrisponde correttamente prima di creare lo ZIP.
