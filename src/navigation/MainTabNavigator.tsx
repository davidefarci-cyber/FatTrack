...
// `Settings` e `Profile` restano registrati come Tab.Screen (raggiungibili
// dalle icone utente/ingranaggio in alto a destra di Home), ma `BottomTabBar`
// li nasconde dalla bar perché non sono in `TAB_CONFIG`.
